...
type ObjectLayer interface {
	...
	// Object operations.
	GetObject(bucket, object string, startOffset int64, length int64, writer io.Writer, encInfo *ServerSideEncryptionInfo) (err error)
	GetObjectInfo(bucket, object string, encInfo *ServerSideEncryptionInfo) (objInfo ObjectInfo, err error)
	...
	CopyObjectPart(srcBucket, srcObject, destBucket, destObject string, uploadID string, partID int, startOffset int64, length int64, encInfo *ServerSideEncryptionInfo) (info PartInfo, err error)
	PutObjectPart(bucket, object, uploadID string, partID int, size int64, data io.Reader, md5Hex string, sha256sum string, encInfo *ServerSideEncryptionInfo) (info PartInfo, err error)
